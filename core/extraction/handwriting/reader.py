...
# ⚠️ **قيمةٌ مؤقّتةٌ غيرُ مُعايَرة.** عُوِيرت على 128 شريطاً من v5 لصيغة الثقة **القديمة**
# (متوسّطُ الرموز المُصدَّرة). وصيغةُ اليوم `_sequence_confidence` احتماليّةُ سلسلةٍ
# مُطبَّعةٌ هندسيّاً — **سُلَّمٌ آخر**، فإبقاء 0.90 يُغيّر التغطية صامتاً. تُعاد المعايرة
# على نصف المعايرة من الحجز، ولا تُختار على مجموعةٍ مختومة أبداً (docs/EVAL_REGISTRY.md).
CONF_GATE = 0.90
