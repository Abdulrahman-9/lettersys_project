...
urlpatterns = [
    ...
    path("api/scan/watcher-status/",     views.scan_watcher_status_api,  name="scan_watcher_status"),
    path("api/scan/diagnostics/",        views.scan_watcher_diagnostics, name="scan_watcher_diagnostics"),
    path("api/scan/test-capture/",       views.scan_test_capture,        name="scan_test_capture"),
    path("api/scan/launch/",             views.scan_launch_api,          name="scan_launch"),
    path("api/scan/check-protocol/",     views.scan_check_protocol,      name="scan_check_protocol"),
    path("api/scan/download-installer/", views.scan_download_installer,  name="scan_download_installer"),
    path("api/scan/install-protocol/",  views.scan_install_protocol,    name="scan_install_protocol"),
    path("api/scan/serve/<str:token>/", views.scan_file_serve,           name="scan_file_serve"),
    path("api/scan/process-local/",    views.scan_process_local_file,   name="scan_process_local"),
