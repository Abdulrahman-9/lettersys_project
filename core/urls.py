...
urlpatterns = [
    ...
    path("restore-data/api/probe/", views.restore_probe, name="restore_probe"),
    path("restore-data/api/reconcile/", views.restore_reconcile, name="restore_reconcile"),
    path("restore-data/api/delta/", views.restore_delta, name="restore_delta"),
