# -*- coding: utf-8 -*-
"""
Book Sequence & Settings Views
معالجات إعدادات الأرقام التسلسلية وتأجيل الحجوزات
"""
import logging
import os
import re
...
from ...extraction_kinds import normalize_book_kind, BOOK_KIND_CHOICES
...
def next_number_api(request):
    """API لإرجاع الرقم التسلسلي التالي لنوع كتاب معيّن."""
...
def sequence_settings(request):
    """صفحة إعدادات العدّادات التسلسلية لأنواع الكتب."""
    sequences = []
...
def _write_reservation_expire_setting(minutes: int):
    """
    يكتب قيمة RESERVATION_EXPIRE_MINUTES في ملف .env في جذر المشروع.
    إذا لم يكن الملف موجوداً ينشئه. آمن للاستخدام من واجهة الإعدادات.
    """
