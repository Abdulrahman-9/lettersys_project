"""e2e-A — أوّل قياسٍ صادق لقراءة العدد من طرفٍ إلى طرف.
...
MAN = r"D:\migration\lettersys_models\e2e_manifest.json"
OUT = r"D:\migration\lettersys_models\e2e_A_results.json"
...
print("المجموع %d · مُقاسٌ %d · **إصابة %d (%.0f%%)** · صامت %d · خاطئ %d · مُستبعَدٌ (مهلة/فشل) %d"
      % (n, len(scored), hit, 100*hit/max(1, len(scored)), silent, wrong, timed_out), flush=True)
